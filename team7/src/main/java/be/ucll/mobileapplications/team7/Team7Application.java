                ...
                return args -> {
                        ...
                        List<Movie> movies = Arrays.asList(
                                        new Movie("Avatar",
                                                        ...
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.FRANÇAIS,
                                                                        Language.DEUTSCH,
                                                                        Language.NEDERLANDS)),
                                        ...
                                        new Movie("Pirates of the Caribbean At World's End",
                                                        new HashSet<>(Arrays.asList(Genre.ACTION, Genre.ADVENTURE,
                                                                        Genre.FANTASY)),
                                        ...
                                        new Movie("The Dark Knight",
                                                        new HashSet<>(Arrays.asList(Genre.ACTION, Genre.CRIME,
                                                                        Genre.DRAMA)),
                                        ...
                                        new Movie("Inception",
                                                        ...
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.FRANÇAIS,
                                                                        Language.NEDERLANDS)),
                                                        new HashSet<>(Arrays.asList(StreamingPlatform.NETFLIX,
                                        ...
                                        new Movie("The Matrix",
                                                        new HashSet<>(Arrays.asList(Genre.ACTION,
                                                                        Genre.SCIENCE_FICTION)),
                                                        ...
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.FRANÇAIS,
                                                                        ...
                                                                        Language.NEDERLANDS)),
                                                        new HashSet<>(Arrays.asList(StreamingPlatform.NETFLIX,
                                                                        StreamingPlatform.AMAZON_FREEVEE)),
                                                        "Free your mind.",
                                                        "The Wachowskis",
                                        ...
                                        new Movie("The Lion King",
                                                        new HashSet<>(Arrays.asList(Genre.ANIMATION, Genre.ADVENTURE,
                                        ...
                                        new Movie("Inglourious Basterds",
                                                        new HashSet<>(Arrays.asList(Genre.ACTION, Genre.DRAMA,
                                                                        Genre.WAR)),
                                                        new Date(2009 - 1900, 7, 21),
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.DEUTSCH,
                                                                        Language.FRANÇAIS)),
                                                        new HashSet<>(Arrays.asList(StreamingPlatform.PRIME_VIDEO,
                                        ...
                                        new Movie("The Revenant",
                                                        new HashSet<>(Arrays.asList(Genre.ADVENTURE, Genre.DRAMA,
                                                                        Genre.THRILLER)),
                                                        new Date(2015 - 1900, 11, 25),
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.FRANÇAIS,
                                                                        Language.NEDERLANDS)),
                                                        new HashSet<>(Arrays.asList(StreamingPlatform.HBO_MAX,
                                                                        StreamingPlatform.PRIME_VIDEO)),
                                                        "Alejandro González Iñárritu", "Revenge is in his nature.",
                                                        "A frontiersman fights for survival after being mauled by a bear and left for dead by members of his hunting team.",
                                                        8.0),

                                        new Movie("Mad Max Fury Road",
                                                        new HashSet<>(Arrays.asList(Genre.ACTION, Genre.ADVENTURE,
                                                                        Genre.SCIENCE_FICTION)),
                                                        new Date(2015 - 1900, 4, 15),
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.FRANÇAIS,
                                                                        Language.DEUTSCH)),
                                                        new HashSet<>(Arrays.asList(StreamingPlatform.NETFLIX,
                                                                        StreamingPlatform.HULU)),
                                                        "George Miller", "What a lovely day.",
                                                        "In a post-apocalyptic wasteland, Max teams up with a runaway warrior to escape a tyrannical warlord and his army.",
                                                        8.1),

                                        new Movie("Django Unchained",
                                                        new HashSet<>(Arrays.asList(Genre.DRAMA, Genre.WESTERN)),
                                                        new Date(2012 - 1900, 11, 25),
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.DEUTSCH,
                                                                        Language.FRANÇAIS)),
                                                        new HashSet<>(Arrays.asList(StreamingPlatform.HBO_MAX,
                                                                        StreamingPlatform.PRIME_VIDEO)),
                                        ...
                                        new Movie("Interstellar",
                                                        ...
                                                        "A group of explorers travel through a wormhole in space to ensure humanity's survival as Earth faces an ecological collapse.",
                                                        8.6),

                                        new Movie("The Social Network",
                                                        new HashSet<>(Arrays.asList(Genre.BIOGRAPHY, Genre.DRAMA)),
                                                        new Date(2010 - 1900, 9, 1),
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.FRANÇAIS,
                                                                        Language.NEDERLANDS)),
                                                        new HashSet<>(Arrays.asList(StreamingPlatform.NETFLIX,
                                                                        StreamingPlatform.HULU)),
                                                        ...
                                                        "The story of how Mark Zuckerberg created Facebook, and the legal battles that followed its success.",
                                                        7.7),

                                        new Movie("The Wolf of Wall Street",
                                                        new HashSet<>(Arrays.asList(Genre.BIOGRAPHY, Genre.COMEDY,
                                                                        Genre.CRIME)),
                                                        new Date(2013 - 1900, 11, 25),
                                                        new HashSet<>(Arrays.asList(Language.ENGLISH, Language.FRANÇAIS,
                                                                        Language.DEUTSCH)),
                                                        new HashSet<>(Arrays.asList(StreamingPlatform.PRIME_VIDEO,
                                                                        StreamingPlatform.NETFLIX)),
                                                        "Martin Scorsese",
                                                        "The story of a man who had everything and lost it all.",
                                                        "The rise and fall of Jordan Belfort, a stockbroker who built a corrupt empire of wealth and excess.",
                                                        8.2));
